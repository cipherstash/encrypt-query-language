...
//! bind into a `jsonb` column. The client (the CIP-3551 value-selector
...
/// comparison (CIP-3551). This is what a client binds for encrypted-JSON field
...
mod live_tests {
    ...
    async fn encrypt_store_with_ope_index_emits_the_op_term() {
        // CIP-3348: the client emits the scalar CLLW-OPE term for
