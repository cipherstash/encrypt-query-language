...
//! storage-only json domain — and its native-jsonb operator firewall
//! (`src/v3/jsonb/storage_blockers.sql`) — a real-ciphertext home, exactly as
//! the `bool` scalar storage fixture does for the scalar storage domains.
