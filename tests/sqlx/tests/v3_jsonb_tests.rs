...
// fixture:generate:all`), not committed. Under the CIP-3551 value-selector wire
...
/// bool/null/object/array PATH entries under the CIP-3551 value-selector wire —
...
//      mixed}. Exact value equality is value-selector PRESENCE (CIP-3551).
// ============================================================================
...
async fn v3_jsonb_containment_constant_value_selector(pool: PgPool) -> anyhow::Result<()> {
    ...
    // Injective end (CIP-3551 exact value equality): a value selector UNIQUE to
...
async fn v3_jsonb_fixture_structural_invariants(pool: PgPool) -> anyhow::Result<()> {
    ...
    // row. Under the CIP-3551 value-selector wire, exact value equality is
