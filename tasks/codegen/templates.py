...
# Rust counterpart of AUTO_GENERATED_HEADER. Unlike the gitignored SQL surface,
# the fixture-value const IS committed and verified by the CI staleness guard,
# so the wording differs deliberately.
AUTO_GENERATED_HEADER_RS = (
    "// AUTO-GENERATED — DO NOT EDIT.\n"
    "// Regenerated by `mise run build` "
    "(or `mise run codegen:domain <type>`).\n"
