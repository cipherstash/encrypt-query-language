...
function_search_path_mutable	eql_v2	eql_v2_int4_eq_eq	function	eql_v2_int4_eq variant equality: inlines to eql_v2.eq_term(a) = eql_v2.eq_term(b) for functional-index engagement on eql_v2.eq_term(col) (USING hash or btree). Three overloads: (domain,domain), (domain,jsonb), (jsonb,domain).
function_search_path_mutable	eql_v2	eql_v2_int4_eq_neq	function	eql_v2_int4_eq variant inequality: same eql_v2.eq_term inlining rationale as eql_v2_int4_eq_eq. Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_ord_ore_eq	function	eql_v2_int4_ord_ore equality: inlines to eql_v2.ord_term(a) = eql_v2.ord_term(b) for functional-btree engagement on eql_v2.ord_term(col). Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_ord_ore_neq	function	eql_v2_int4_ord_ore inequality: same eql_v2.ord_term inlining rationale as eql_v2_int4_ord_ore_eq. Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_ord_ore_lt	function	eql_v2_int4_ord_ore range: inlines to eql_v2.ord_term(a) < eql_v2.ord_term(b) for functional-btree engagement on eql_v2.ord_term(col). Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_ord_ore_lte	function	eql_v2_int4_ord_ore range: same eql_v2.ord_term inlining rationale as eql_v2_int4_ord_ore_lt. Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_ord_ore_gt	function	eql_v2_int4_ord_ore range: same eql_v2.ord_term inlining rationale as eql_v2_int4_ord_ore_lt. Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_ord_ore_gte	function	eql_v2_int4_ord_ore range: same eql_v2.ord_term inlining rationale as eql_v2_int4_ord_ore_lt. Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_ord_eq	function	eql_v2_int4_ord equality (D-E fallback concrete domain): inlines to eql_v2.ord_term(a) = eql_v2.ord_term(b), same rationale as eql_v2_int4_ord_ore_eq. Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_ord_neq	function	eql_v2_int4_ord inequality (D-E fallback): same eql_v2.ord_term inlining rationale as eql_v2_int4_ord_eq. Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_ord_lt	function	eql_v2_int4_ord range (D-E fallback): inlines to eql_v2.ord_term(a) < eql_v2.ord_term(b), same rationale as eql_v2_int4_ord_ore_lt. Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_ord_lte	function	eql_v2_int4_ord range (D-E fallback): same eql_v2.ord_term inlining rationale as eql_v2_int4_ord_lt. Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_ord_gt	function	eql_v2_int4_ord range (D-E fallback): same eql_v2.ord_term inlining rationale as eql_v2_int4_ord_lt. Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_ord_gte	function	eql_v2_int4_ord range (D-E fallback): same eql_v2.ord_term inlining rationale as eql_v2_int4_ord_lt. Three overloads.
ALLOW
