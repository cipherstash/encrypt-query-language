...
function_search_path_mutable	eql_v2	eql_v2_int4_lt	function	eql_v2_int4 default-variant range: wrapper stays SQL+IMMUTABLE for parity with _ord_ope; body reduces to compare_ore_block_u64_8_256(a::eql_v2_encrypted, b::eql_v2_encrypted) < 0. compare_ore_block_u64_8_256 is PL/pgSQL and does not inline, so range queries are seq-scan; see docs/upgrading/v2.4.md U-001 (Range-index limitation). Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_lte	function	eql_v2_int4 default-variant range: same compare_ore_block_u64_8_256 seq-scan rationale as eql_v2_int4_lt. Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_gt	function	eql_v2_int4 default-variant range: same compare_ore_block_u64_8_256 seq-scan rationale as eql_v2_int4_lt. Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_gte	function	eql_v2_int4 default-variant range: same compare_ore_block_u64_8_256 seq-scan rationale as eql_v2_int4_lt. Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_eq_eq	function	eql_v2_int4_eq variant equality: HMAC wrapper, same hmac_256 inlining rationale as eql_v2_int4_eq. Three overloads.
...
function_search_path_mutable	eql_v2	eql_v2_int4_ord_ore_eq	function	eql_v2_int4_ord_ore variant equality: HMAC wrapper, same hmac_256 inlining rationale as eql_v2_int4_eq. Three overloads.
...
function_search_path_mutable	eql_v2	eql_v2_int4_ord_ore_lt	function	eql_v2_int4_ord_ore variant range: wrapper stays SQL+IMMUTABLE for parity with _ord_ope; body reduces to compare_ore_block_u64_8_256(a::eql_v2_encrypted, b::eql_v2_encrypted) < 0. compare_ore_block_u64_8_256 is PL/pgSQL and does not inline, so range queries are seq-scan; see docs/upgrading/v2.4.md U-001 (Range-index limitation). Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_ord_ore_lte	function	eql_v2_int4_ord_ore variant range: same compare_ore_block_u64_8_256 seq-scan rationale as eql_v2_int4_ord_ore_lt. Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_ord_ore_gt	function	eql_v2_int4_ord_ore variant range: same compare_ore_block_u64_8_256 seq-scan rationale as eql_v2_int4_ord_ore_lt. Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_ord_ore_gte	function	eql_v2_int4_ord_ore variant range: same compare_ore_block_u64_8_256 seq-scan rationale as eql_v2_int4_ord_ore_lt. Three overloads.
function_search_path_mutable	eql_v2	eql_v2_int4_ord_ope_eq	function	eql_v2_int4_ord_ope variant equality: HMAC wrapper, same hmac_256 inlining rationale as eql_v2_int4_eq. Three overloads.
