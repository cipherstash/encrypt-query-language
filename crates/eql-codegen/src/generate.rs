...
/// surface at all (CIP-3551): exact field equality is document containment on the
...
///
/// **Why equality never lives on the extract surface (CIP-3551).** An extracted
...
fn json_entry_cross_operators(spec: &DomainFamily) -> Vec<&'static str> {
    ...
    // the kind (equality left the extract surface in CIP-3551), but keeping the
...
mod tests {
    ...
    fn json_entry_cross_operator_set_is_exactly_what_the_term_provides() {
        ...
        // family (CIP-3551): it lives on the document-containment surface
    ...
    fn json_entry_never_serves_equality_on_the_extract_surface() {
        // CIP-3551: equality is not an extract operation for ANY family. An
    ...
    fn json_entry_cross_functions_bind_json_entry_to_query_operands() {
        ...
        // Equality is never an extract op (CIP-3551); it is document containment.
    ...
    fn json_entry_cross_operators_carry_planner_metadata() {
        ...
        // (CIP-3551 — equality is document containment, not an extract op).
    ...
    fn json_entry_cross_functions_text_emits_ordering_only_never_equality() {
        ...
        // ORDERING ONLY on the extract surface (CIP-3551). `op` is deterministic, so
