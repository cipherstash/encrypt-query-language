...
pub use record::{
    TypeFixtures, BIGINT_FIXTURES, BOOLEAN_FIXTURES, DATE_FIXTURES, DOUBLE_FIXTURES, FIXTURES,
    INTEGER_FIXTURES, JSONB_FIXTURES, NUMERIC_FIXTURES, REAL_FIXTURES, SMALLINT_FIXTURES,
