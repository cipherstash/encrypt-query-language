...
pub use fixtures::{
    BoundedIntKind, Fixture, ScalarKind, TypeFixtures, BOOLEAN_FIXTURES, DATE_FIXTURES, FIXTURES,
    REAL_FIXTURES, DOUBLE_FIXTURES, SMALLINT_FIXTURES, SMALLINT_VALUES, INTEGER_FIXTURES, INTEGER_VALUES,
    BIGINT_FIXTURES, BIGINT_VALUES, JSONB_FIXTURES, NUMERIC_FIXTURES, TEXT_FIXTURES, TEXT_VALUES,
    TIMESTAMP_FIXTURES,
};
