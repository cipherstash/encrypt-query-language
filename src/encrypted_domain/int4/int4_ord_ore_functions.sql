...
CREATE FUNCTION eql_v2.ord(a eql_v2_int4_ord_ore)
...
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v2.ord(a) < eql_v2.ord(b::eql_v2_int4_ord_ore) $$;
...
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v2.ord(a::eql_v2_int4_ord_ore) < eql_v2.ord(b) $$;
