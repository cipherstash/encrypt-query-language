...
CREATE OPERATOR CLASS eql_v3_internal.ore_cllw_ops
  ...
  USING btree FAMILY eql_v3_internal.ore_cllw_ops AS
    OPERATOR 1 <  (eql_v3_internal.ore_cllw, eql_v3_internal.ore_cllw),
    OPERATOR 2 <= (eql_v3_internal.ore_cllw, eql_v3_internal.ore_cllw),
    OPERATOR 3 =  (eql_v3_internal.ore_cllw, eql_v3_internal.ore_cllw),
    OPERATOR 4 >= (eql_v3_internal.ore_cllw, eql_v3_internal.ore_cllw),
    OPERATOR 5 >  (eql_v3_internal.ore_cllw, eql_v3_internal.ore_cllw),
