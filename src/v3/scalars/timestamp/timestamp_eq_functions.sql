...
--! @return boolean
CREATE FUNCTION eql_v3_internal.eq(a eql_v3.timestamp_eq, b eql_v3.timestamp_eq)
...
--! @param b jsonb
--! @return boolean
CREATE FUNCTION eql_v3_internal.eq(a eql_v3.timestamp_eq, b jsonb)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
...
--! @param b eql_v3.timestamp_eq
--! @return boolean
CREATE FUNCTION eql_v3_internal.eq(a jsonb, b eql_v3.timestamp_eq)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
...
--! @param b eql_v3.timestamp_eq
--! @return boolean
CREATE FUNCTION eql_v3_internal.neq(a eql_v3.timestamp_eq, b eql_v3.timestamp_eq)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.eq_term(a) <> eql_v3.eq_term(b) $$;
...
--! @param b jsonb
--! @return boolean
CREATE FUNCTION eql_v3_internal.neq(a eql_v3.timestamp_eq, b jsonb)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.eq_term(a) <> eql_v3.eq_term(b::eql_v3.timestamp_eq) $$;
...
--! @param b eql_v3.timestamp_eq
--! @return boolean
CREATE FUNCTION eql_v3_internal.neq(a jsonb, b eql_v3.timestamp_eq)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.eq_term(a::eql_v3.timestamp_eq) <> eql_v3.eq_term(b) $$;
