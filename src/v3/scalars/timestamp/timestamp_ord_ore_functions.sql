...
--! @return boolean
CREATE FUNCTION eql_v3_internal.eq(a eql_v3.timestamp_ord_ore, b eql_v3.timestamp_ord_ore)
...
--! @param b jsonb
--! @return boolean
CREATE FUNCTION eql_v3_internal.eq(a eql_v3.timestamp_ord_ore, b jsonb)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
...
--! @param b eql_v3.timestamp_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3_internal.eq(a jsonb, b eql_v3.timestamp_ord_ore)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
...
--! @param b eql_v3.timestamp_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3_internal.neq(a eql_v3.timestamp_ord_ore, b eql_v3.timestamp_ord_ore)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) <> eql_v3.ord_term(b) $$;
...
--! @param b jsonb
--! @return boolean
CREATE FUNCTION eql_v3_internal.neq(a eql_v3.timestamp_ord_ore, b jsonb)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) <> eql_v3.ord_term(b::eql_v3.timestamp_ord_ore) $$;
...
--! @param b eql_v3.timestamp_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3_internal.neq(a jsonb, b eql_v3.timestamp_ord_ore)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a::eql_v3.timestamp_ord_ore) <> eql_v3.ord_term(b) $$;
...
--! @param b eql_v3.timestamp_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3_internal.lt(a eql_v3.timestamp_ord_ore, b eql_v3.timestamp_ord_ore)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) < eql_v3.ord_term(b) $$;
...
--! @param b jsonb
--! @return boolean
CREATE FUNCTION eql_v3_internal.lt(a eql_v3.timestamp_ord_ore, b jsonb)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) < eql_v3.ord_term(b::eql_v3.timestamp_ord_ore) $$;
...
--! @param b eql_v3.timestamp_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3_internal.lt(a jsonb, b eql_v3.timestamp_ord_ore)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a::eql_v3.timestamp_ord_ore) < eql_v3.ord_term(b) $$;
...
--! @param b eql_v3.timestamp_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3_internal.lte(a eql_v3.timestamp_ord_ore, b eql_v3.timestamp_ord_ore)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) <= eql_v3.ord_term(b) $$;
...
--! @param b jsonb
--! @return boolean
CREATE FUNCTION eql_v3_internal.lte(a eql_v3.timestamp_ord_ore, b jsonb)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) <= eql_v3.ord_term(b::eql_v3.timestamp_ord_ore) $$;
...
--! @param b eql_v3.timestamp_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3_internal.lte(a jsonb, b eql_v3.timestamp_ord_ore)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a::eql_v3.timestamp_ord_ore) <= eql_v3.ord_term(b) $$;
...
--! @param b eql_v3.timestamp_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3_internal.gt(a eql_v3.timestamp_ord_ore, b eql_v3.timestamp_ord_ore)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) > eql_v3.ord_term(b) $$;
...
--! @param b jsonb
--! @return boolean
CREATE FUNCTION eql_v3_internal.gt(a eql_v3.timestamp_ord_ore, b jsonb)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) > eql_v3.ord_term(b::eql_v3.timestamp_ord_ore) $$;
...
--! @param b eql_v3.timestamp_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3_internal.gt(a jsonb, b eql_v3.timestamp_ord_ore)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a::eql_v3.timestamp_ord_ore) > eql_v3.ord_term(b) $$;
...
--! @param b eql_v3.timestamp_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3_internal.gte(a eql_v3.timestamp_ord_ore, b eql_v3.timestamp_ord_ore)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) >= eql_v3.ord_term(b) $$;
...
--! @param b jsonb
--! @return boolean
CREATE FUNCTION eql_v3_internal.gte(a eql_v3.timestamp_ord_ore, b jsonb)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) >= eql_v3.ord_term(b::eql_v3.timestamp_ord_ore) $$;
...
--! @param b eql_v3.timestamp_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3_internal.gte(a jsonb, b eql_v3.timestamp_ord_ore)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a::eql_v3.timestamp_ord_ore) >= eql_v3.ord_term(b) $$;
