...
--! @param b eql_v3.numeric_ord_ope
--! @return boolean
CREATE FUNCTION eql_v3.contains(a eql_v3.numeric_ord_ope, b eql_v3.numeric_ord_ope)
...
--! @param b jsonb
--! @return boolean
CREATE FUNCTION eql_v3.contains(a eql_v3.numeric_ord_ope, b jsonb)
RETURNS boolean IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '@>', 'eql_v3.numeric_ord_ope'; END; $$
LANGUAGE plpgsql;
...
--! @param b eql_v3.numeric_ord_ope
--! @return boolean
CREATE FUNCTION eql_v3.contains(a jsonb, b eql_v3.numeric_ord_ope)
RETURNS boolean IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '@>', 'eql_v3.numeric_ord_ope'; END; $$
LANGUAGE plpgsql;
...
--! @param b eql_v3.numeric_ord_ope
--! @return boolean
CREATE FUNCTION eql_v3.contained_by(a eql_v3.numeric_ord_ope, b eql_v3.numeric_ord_ope)
RETURNS boolean IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '<@', 'eql_v3.numeric_ord_ope'; END; $$
LANGUAGE plpgsql;
...
--! @param b jsonb
--! @return boolean
CREATE FUNCTION eql_v3.contained_by(a eql_v3.numeric_ord_ope, b jsonb)
RETURNS boolean IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '<@', 'eql_v3.numeric_ord_ope'; END; $$
LANGUAGE plpgsql;
...
--! @param b eql_v3.numeric_ord_ope
--! @return boolean
CREATE FUNCTION eql_v3.contained_by(a jsonb, b eql_v3.numeric_ord_ope)
RETURNS boolean IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '<@', 'eql_v3.numeric_ord_ope'; END; $$
LANGUAGE plpgsql;
...
CREATE FUNCTION eql_v3."->"(a eql_v3.numeric_ord_ope, selector text)
...
--! @return eql_v3.numeric_ord_ope
CREATE FUNCTION eql_v3."->"(a eql_v3.numeric_ord_ope, selector integer)
RETURNS eql_v3.numeric_ord_ope IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '->', 'eql_v3.numeric_ord_ope'; END; $$
LANGUAGE plpgsql;
...
--! @return eql_v3.numeric_ord_ope
CREATE FUNCTION eql_v3."->"(a jsonb, selector eql_v3.numeric_ord_ope)
RETURNS eql_v3.numeric_ord_ope IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '->', 'eql_v3.numeric_ord_ope'; END; $$
LANGUAGE plpgsql;
...
--! @param b text
--! @return boolean
CREATE FUNCTION eql_v3."?"(a eql_v3.numeric_ord_ope, b text)
RETURNS boolean IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '?', 'eql_v3.numeric_ord_ope'; END; $$
LANGUAGE plpgsql;
...
--! @param b jsonpath
--! @return boolean
CREATE FUNCTION eql_v3."@?"(a eql_v3.numeric_ord_ope, b jsonpath)
RETURNS boolean IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '@?', 'eql_v3.numeric_ord_ope'; END; $$
LANGUAGE plpgsql;
...
--! @param b integer
--! @return jsonb
CREATE FUNCTION eql_v3."-"(a eql_v3.numeric_ord_ope, b integer)
RETURNS jsonb IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '-', 'eql_v3.numeric_ord_ope'; END; $$
LANGUAGE plpgsql;
...
--! @param b eql_v3.numeric_ord_ope
--! @return jsonb
CREATE FUNCTION eql_v3."||"(a eql_v3.numeric_ord_ope, b eql_v3.numeric_ord_ope)
RETURNS jsonb IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '||', 'eql_v3.numeric_ord_ope'; END; $$
LANGUAGE plpgsql;
...
--! @param b jsonb
--! @return jsonb
CREATE FUNCTION eql_v3."||"(a eql_v3.numeric_ord_ope, b jsonb)
RETURNS jsonb IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '||', 'eql_v3.numeric_ord_ope'; END; $$
LANGUAGE plpgsql;
...
--! @param b eql_v3.numeric_ord_ope
--! @return jsonb
CREATE FUNCTION eql_v3."||"(a jsonb, b eql_v3.numeric_ord_ope)
RETURNS jsonb IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '||', 'eql_v3.numeric_ord_ope'; END; $$
LANGUAGE plpgsql;
