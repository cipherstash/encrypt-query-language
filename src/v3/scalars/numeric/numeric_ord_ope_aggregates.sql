...
CREATE FUNCTION eql_v3.min_sfunc(state eql_v3.numeric_ord_ope, value eql_v3.numeric_ord_ope)
...
--! @param value eql_v3.numeric_ord_ope
--! @return eql_v3.numeric_ord_ope
CREATE FUNCTION eql_v3.max_sfunc(state eql_v3.numeric_ord_ope, value eql_v3.numeric_ord_ope)
RETURNS eql_v3.numeric_ord_ope
LANGUAGE plpgsql IMMUTABLE STRICT PARALLEL SAFE
SET search_path = pg_catalog, extensions, public
AS $$
