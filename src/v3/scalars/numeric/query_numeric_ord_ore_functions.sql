...
--! @brief Functions for public.query_numeric_ord_ore.

--! @brief Index extractor for public.query_numeric_ord_ore.
--! @param a public.query_numeric_ord_ore
--! @return eql_v3_internal.ore_block_256
CREATE FUNCTION eql_v3.ord_term(a public.query_numeric_ord_ore)
RETURNS eql_v3_internal.ore_block_256
LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3_internal.ore_block_256(a::jsonb) $$;

--! @brief Operator wrapper for public.query_numeric_ord_ore.
--! @param a public.numeric_ord_ore
--! @param b public.query_numeric_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3.eq(a public.numeric_ord_ore, b public.query_numeric_ord_ore)
...
--! @param b public.query_numeric_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3.neq(a public.numeric_ord_ore, b public.query_numeric_ord_ore)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) <> eql_v3.ord_term(b) $$;
...
--! @param b public.query_numeric_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3.lt(a public.numeric_ord_ore, b public.query_numeric_ord_ore)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) < eql_v3.ord_term(b) $$;
...
--! @param b public.query_numeric_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3.lte(a public.numeric_ord_ore, b public.query_numeric_ord_ore)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) <= eql_v3.ord_term(b) $$;
...
--! @param b public.query_numeric_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3.gt(a public.numeric_ord_ore, b public.query_numeric_ord_ore)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) > eql_v3.ord_term(b) $$;
...
--! @param b public.query_numeric_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3.gte(a public.numeric_ord_ore, b public.query_numeric_ord_ore)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) >= eql_v3.ord_term(b) $$;
