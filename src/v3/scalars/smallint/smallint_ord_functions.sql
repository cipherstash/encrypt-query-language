...
CREATE FUNCTION eql_v3.ord_ope_term(a public.eql_v3_smallint_ord)
...
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_ope_term(a) = eql_v3.ord_ope_term(b::public.eql_v3_smallint_ord) $$;
...
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_ope_term(a::public.eql_v3_smallint_ord) = eql_v3.ord_ope_term(b) $$;
