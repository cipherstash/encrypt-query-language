...
--! @param b eql_v3.int8_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3_internal.contains(a eql_v3.int8_ord_ore, b eql_v3.int8_ord_ore)
...
--! @param b jsonb
--! @return boolean
CREATE FUNCTION eql_v3_internal.contains(a eql_v3.int8_ord_ore, b jsonb)
RETURNS boolean IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '@>', 'eql_v3.int8_ord_ore'; END; $$
LANGUAGE plpgsql;
...
--! @param b eql_v3.int8_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3_internal.contains(a jsonb, b eql_v3.int8_ord_ore)
RETURNS boolean IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '@>', 'eql_v3.int8_ord_ore'; END; $$
LANGUAGE plpgsql;
...
--! @param b eql_v3.int8_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3_internal.contained_by(a eql_v3.int8_ord_ore, b eql_v3.int8_ord_ore)
RETURNS boolean IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '<@', 'eql_v3.int8_ord_ore'; END; $$
LANGUAGE plpgsql;
...
--! @param b jsonb
--! @return boolean
CREATE FUNCTION eql_v3_internal.contained_by(a eql_v3.int8_ord_ore, b jsonb)
RETURNS boolean IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '<@', 'eql_v3.int8_ord_ore'; END; $$
LANGUAGE plpgsql;
...
--! @param b eql_v3.int8_ord_ore
--! @return boolean
CREATE FUNCTION eql_v3_internal.contained_by(a jsonb, b eql_v3.int8_ord_ore)
RETURNS boolean IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '<@', 'eql_v3.int8_ord_ore'; END; $$
LANGUAGE plpgsql;
...
CREATE FUNCTION eql_v3_internal."->"(a eql_v3.int8_ord_ore, selector text)
...
--! @return eql_v3.int8_ord_ore
CREATE FUNCTION eql_v3_internal."->"(a eql_v3.int8_ord_ore, selector integer)
RETURNS eql_v3.int8_ord_ore IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '->', 'eql_v3.int8_ord_ore'; END; $$
LANGUAGE plpgsql;
...
--! @return eql_v3.int8_ord_ore
CREATE FUNCTION eql_v3_internal."->"(a jsonb, selector eql_v3.int8_ord_ore)
RETURNS eql_v3.int8_ord_ore IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '->', 'eql_v3.int8_ord_ore'; END; $$
LANGUAGE plpgsql;
...
--! @param b text
--! @return boolean
CREATE FUNCTION eql_v3_internal."?"(a eql_v3.int8_ord_ore, b text)
RETURNS boolean IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '?', 'eql_v3.int8_ord_ore'; END; $$
LANGUAGE plpgsql;
...
--! @param b jsonpath
--! @return boolean
CREATE FUNCTION eql_v3_internal."@?"(a eql_v3.int8_ord_ore, b jsonpath)
RETURNS boolean IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '@?', 'eql_v3.int8_ord_ore'; END; $$
LANGUAGE plpgsql;
...
--! @param b integer
--! @return jsonb
CREATE FUNCTION eql_v3_internal."-"(a eql_v3.int8_ord_ore, b integer)
RETURNS jsonb IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '-', 'eql_v3.int8_ord_ore'; END; $$
LANGUAGE plpgsql;
...
--! @param b eql_v3.int8_ord_ore
--! @return jsonb
CREATE FUNCTION eql_v3_internal."||"(a eql_v3.int8_ord_ore, b eql_v3.int8_ord_ore)
RETURNS jsonb IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '||', 'eql_v3.int8_ord_ore'; END; $$
LANGUAGE plpgsql;
...
--! @param b jsonb
--! @return jsonb
CREATE FUNCTION eql_v3_internal."||"(a eql_v3.int8_ord_ore, b jsonb)
RETURNS jsonb IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '||', 'eql_v3.int8_ord_ore'; END; $$
LANGUAGE plpgsql;
...
--! @param b eql_v3.int8_ord_ore
--! @return jsonb
CREATE FUNCTION eql_v3_internal."||"(a jsonb, b eql_v3.int8_ord_ore)
RETURNS jsonb IMMUTABLE PARALLEL SAFE
AS $$ BEGIN RAISE EXCEPTION 'operator % is not supported for %', '||', 'eql_v3.int8_ord_ore'; END; $$
LANGUAGE plpgsql;
