...
BEGIN
  ...
  COMMENT ON DOMAIN public.bigint IS 'EQL v3 encrypted bigint column (storage only, not searchable). jsonb-backed CipherStash searchable-encryption domain.';
  ...
  COMMENT ON DOMAIN public.bigint_eq IS 'EQL v3 encrypted bigint column (searchable via = <>). jsonb-backed CipherStash searchable-encryption domain.';
  ...
  COMMENT ON DOMAIN public.bigint_ord_ore IS 'EQL v3 encrypted bigint column (searchable via = <> < <= > >=). jsonb-backed CipherStash searchable-encryption domain.';
  ...
  COMMENT ON DOMAIN public.bigint_ord IS 'EQL v3 encrypted bigint column (searchable via = <> < <= > >=). jsonb-backed CipherStash searchable-encryption domain.';
  ...
  COMMENT ON DOMAIN public.bigint_ord_ope IS 'EQL v3 encrypted bigint column (searchable via = <> < <= > >=). jsonb-backed CipherStash searchable-encryption domain.';
END
$$;
