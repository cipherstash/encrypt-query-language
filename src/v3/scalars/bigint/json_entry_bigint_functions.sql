...
--! @return boolean
CREATE FUNCTION eql_v3.eq(a public.eql_v3_json_entry, b eql_v3.query_bigint_eq)
...
--! @return boolean
CREATE FUNCTION eql_v3.eq(a eql_v3.query_bigint_eq, b public.eql_v3_json_entry)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.eq_term(a) = eql_v3.eq_term(b) $$;
...
--! @param b eql_v3.query_bigint_eq
--! @return boolean
CREATE FUNCTION eql_v3.neq(a public.eql_v3_json_entry, b eql_v3.query_bigint_eq)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.eq_term(a) <> eql_v3.eq_term(b) $$;
...
--! @param b public.eql_v3_json_entry
--! @return boolean
CREATE FUNCTION eql_v3.neq(a eql_v3.query_bigint_eq, b public.eql_v3_json_entry)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.eq_term(a) <> eql_v3.eq_term(b) $$;
...
--! @return boolean
CREATE FUNCTION eql_v3.eq(a public.eql_v3_json_entry, b eql_v3.query_bigint_ord)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
...
--! @param b public.eql_v3_json_entry
--! @return boolean
CREATE FUNCTION eql_v3.eq(a eql_v3.query_bigint_ord, b public.eql_v3_json_entry)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) = eql_v3.ord_term(b) $$;
...
--! @param b eql_v3.query_bigint_ord
--! @return boolean
CREATE FUNCTION eql_v3.neq(a public.eql_v3_json_entry, b eql_v3.query_bigint_ord)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) <> eql_v3.ord_term(b) $$;
...
--! @param b public.eql_v3_json_entry
--! @return boolean
CREATE FUNCTION eql_v3.neq(a eql_v3.query_bigint_ord, b public.eql_v3_json_entry)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) <> eql_v3.ord_term(b) $$;
...
--! @return boolean
CREATE FUNCTION eql_v3.eq(a public.eql_v3_json_entry, b eql_v3.query_bigint_ord_ope)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) = eql_v3.ord_term(b) $$;
...
--! @param b public.eql_v3_json_entry
--! @return boolean
CREATE FUNCTION eql_v3.eq(a eql_v3.query_bigint_ord_ope, b public.eql_v3_json_entry)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) = eql_v3.ord_term(b) $$;
...
--! @param b eql_v3.query_bigint_ord_ope
--! @return boolean
CREATE FUNCTION eql_v3.neq(a public.eql_v3_json_entry, b eql_v3.query_bigint_ord_ope)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) <> eql_v3.ord_term(b) $$;
...
--! @param b public.eql_v3_json_entry
--! @return boolean
CREATE FUNCTION eql_v3.neq(a eql_v3.query_bigint_ord_ope, b public.eql_v3_json_entry)
RETURNS boolean LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
AS $$ SELECT eql_v3.ord_term(a) <> eql_v3.ord_term(b) $$;
