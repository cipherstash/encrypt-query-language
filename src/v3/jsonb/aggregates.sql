...
--! @return public.eql_v3_jsonb_entry The lesser orderable entry by `ore_cllw`.
...
--! @return public.eql_v3_jsonb_entry The entry with the smallest CLLW ORE term.
...
--! @param state public.eql_v3_jsonb_entry Running extremum.
--! @param value public.eql_v3_jsonb_entry Candidate entry.
--! @return public.eql_v3_jsonb_entry The greater orderable entry by `ore_cllw`.
...
--! @param input public.eql_v3_jsonb_entry
--! @return public.eql_v3_jsonb_entry The entry with the largest CLLW ORE term.
