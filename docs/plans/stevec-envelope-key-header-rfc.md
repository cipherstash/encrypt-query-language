...
**Relates to:** CIP-3551 (value-inclusive selectors), `eql-payload-scheme-discipline-rfc.md`
...
The change is breaking at the wire level. It ships inside the CIP-3551 /
Stack 1.0 window, which is already breaking and already requires re-encryption;
