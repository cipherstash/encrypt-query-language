...
The `public.eql_v3_json` document type extracts entry-level terms with `eql_v3.eq_term(public.eql_v3_jsonb_entry)` and `eql_v3.ore_cllw(public.eql_v3_jsonb_entry)` — see [json-support.md](./json-support.md).
