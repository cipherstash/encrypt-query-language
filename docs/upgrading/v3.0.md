...
| Column-domain names (`public.integer`, `public.json`, … — 3.0.0 pre-releases only) | **Changed.** Now carry the `eql_v3_` prefix: `public.eql_v3_integer`, `public.eql_v3_json`, … — see U-005. |
...
SELECT '{"v":3,"i":{"t":"t","c":"c"},"c":"ct","ob":["aa"]}'::jsonb::public.eql_v3_integer_ord;
-- And the OPE alternative must work:
SELECT '{"v":3,"i":{"t":"t","c":"c"},"c":"ct","op":"aa"}'::jsonb::public.eql_v3_integer_ord_ope;
...
### U-005: Public column domains carry the `eql_v3_` prefix
